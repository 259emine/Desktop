...
namespace NYP.Giris
{
    class Asker
    {
      //  public string Adi;
        ...
        private string adi; //veri tutulucak entegre
        public string Adi //erişim
        {
            get { return adi; }
            set { adi = Char.ToUpper(value[0]) + value.Substring(1).ToLower(); } //bu kısımda isimlerin ilk harfi büyük diğerleri küçük yazar
        }
        ...
        {
            get { return soyadi; }
            set { soyadi = value.ToUpper(); }  //bu kısımda soyadlarını büyük yazar
        }
